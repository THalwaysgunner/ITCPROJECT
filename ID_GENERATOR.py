...
def get_id(data):
    ...
    evry time we have to generate a new id brfore we populate our table we will read the file - if the symbol already
    ...
    try:
        ...
        for i in data['Symbol']:
            ...
            if sym in unique_id_dic:
                ...
                boolean = data['ID'].is_unique
                cfl.logging.info(f'generate unique id for {i}\n')
